...
Execute Phase 3: Review with the Power Trio committee.
...
**CRITICAL**: If there's an implementation report, run this step BEFORE invoking any specialists to avoid unnecessary work.
...
Generated by Power Trio: Reviewing
Security findings: [X]
...
Return to Phase 2 to address blocking issues, then re-run /power-trio:review.
...
- If implementation.report not found: ask user for feature to review
